import type { Catalog } from "../../src/core/types/catalog-types";
import { describe, expect, it } from "vitest";
import { ErrorSeverity } from "../../src/core/constants";
import { ErrorCatalog } from "../../src/core/catalog";
...
describe("CodeHandlerError", () => {
  ...
  describe("toString", () => {
    it("should return a string representation of the error", () => {
      ...
      // Assert
      expect(errorString).toBe("[CRITICAL] CodeHandlerError: Test error");
    });
  });
});
